...
namespace MailApp.Models.Messages
{
    public class NewMessageViewModel //: IValidatableObject
    {
        ...
        //    {
        //        yield return new ValidationResult("Message Receiver is required.", new List<string> { "Receiver"});
        //    }
        //    if (string.IsNullOrEmpty(Subject) && string.IsNullOrEmpty(Text))
        //    {
        //        yield return new ValidationResult("Message has to have subject or text.", new List<string> { "Subject"});
        //    }
        //}
    }
}